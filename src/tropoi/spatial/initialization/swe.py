...
from tropoi.spatial.truncation import require_scenario_support
from tropoi.spatial.williamson5 import W5_U0_MS

if TYPE_CHECKING:  # annotation only: the factories read model attributes
...
def make_swe_ic(name: str, model: ShallowWaterModel) -> ShallowWaterState:
    ...
    # SWE_SCENARIO_SUPPORT, re-exported by run/swe/config); direct low-level state construction stays
