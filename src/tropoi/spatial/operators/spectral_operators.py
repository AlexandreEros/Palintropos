...
from tropoi.spatial.operators.differential_operators_spherical import DifferentialOperatorsSpherical
...
class SpectralOperators:
    ...
    def __init__(self, sh: GeodesicSphericalHarmonics, radius: float, grid: GeodesicGridGeometry,
        ...
        """
        from tropoi.spatial.spherical_backend import make_backend
