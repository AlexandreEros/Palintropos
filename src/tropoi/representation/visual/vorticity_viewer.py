...
from tropoi.representation.visual.maps import plot_velocity_streamlines
...
class VorticityViewer:
    ...
    def plot_all_snapshots(self, scenario="snapshots", out_dir=None,
        ...
        from tropoi.representation.visual.timeline import render_figure_timeline
    ...
    def summary_spec(self):
        ...
        from tropoi.representation.visual.bve import build_bve_summary_spec
